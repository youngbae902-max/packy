...
import { Download, Star, Image as ImageIcon, Crown, Heart, Bookmark, ExternalLink, Pin } from 'lucide-react';
      ...
      <div className="pack-card animate-fade-in overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center gap-3">
          <div className="flex flex-wrap items-center justify-center gap-2">
            {pack.is_pinned && (
              <span className="inline-flex items-center gap-1 bg-primary/20 text-primary px-2.5 py-1 rounded-full text-xs font-bold uppercase tracking-wide">
            ...
            {showAdminBadge && pack.is_admin_pack && (
              <span className="inline-flex items-center gap-1 bg-destructive/20 text-destructive px-2.5 py-1 rounded-full text-xs font-bold uppercase tracking-wide">
                ADM
              </span>
            )}
          </div>
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className={`flex items-center gap-1 text-sm transition-colors ${
                hasLiked ? 'text-destructive' : 'text-muted-foreground hover:text-foreground'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-1 text-sm transition-colors ${
                hasFavorited ? 'text-warning' : 'text-muted-foreground hover:text-foreground'
              }`}
            >
          ...
          <button 
            ...
            className="btn-download mt-2 w-full"
          >
